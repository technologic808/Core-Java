...
public class ValidationRules {
	...
	public static String validatePRN(HashMap<String, Student> students, String prn) throws StudentHandlingException {
		if (students.containsKey(prn))
			throw new StudentHandlingException("\nError: PRN already exists\n");
		return prn;
	}

	public static String reverseValidatePRN(HashMap<String, Student> students, String prn)
			throws StudentHandlingException {
		if (!students.containsKey(prn))
